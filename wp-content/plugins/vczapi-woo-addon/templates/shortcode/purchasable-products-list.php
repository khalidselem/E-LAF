...
<div class="vczapi-purchasable-meetings">
    <table class="vczapi-purchasable-meetings--table">
        <thead>
        <tr>
            <td><?php _e( 'Meeting Title', 'vczapi-woo-addon' ); ?></td>
            <td><?php _e( 'Host', 'vczapi-woo-addon' ); ?></td>
            <td><?php _e( 'Start Date', 'vczapi-woo-addon' ); ?></td>
            <td><?php _e( 'Timezone', 'vczapi-woo-addon' ); ?></td>
            <td><?php _e( 'View', 'vczapi-woo-addon' ); ?></td>
        </tr>
        </thead>
		<?php
		if ( $zoom_products->have_posts() ) {
			while ( $zoom_products->have_posts() ):
                ...
                <tr class="vczapi-purchasable-meetings--table__row">
                    ...
                    <td><a href="<?php echo esc_url( get_the_permalink() ) ?>" class="btn"><?php _e( 'Details', 'vczapi-woo-addon' ); ?></a>
                    </td>
                </tr>
			<?php
			endwhile;
			...
			?>
            <tr>
                <td colspan="5"><?php _e( 'No upcoming meetings.', 'vczapi-woo-addon' ); ?></td>
            </tr>
			<?php
		}
		?>
