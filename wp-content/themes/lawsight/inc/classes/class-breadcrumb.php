...
class CMS_Breadcrumb
{
    ...
    function __construct( $args = array() )
    {
        ...
        $breadcrumb_home_text = lawsight_get_opt( 'breadcrumb_home_text');
        if(!empty($breadcrumb_home_text)) {
            $breadcrumb_home_label = $breadcrumb_home_text;
        } else {
            $breadcrumb_home_label = esc_html__( 'Home', 'lawsight' );
        }
