 ...
 */
get_header();
$sidebar_pos = lawsight_get_opt( 'post_sidebar_pos', 'right' );
$show_sidebar_post = lawsight_get_page_opt( 'show_sidebar_post', false );
if ($show_sidebar_post){
    $sidebar_pos = lawsight_get_page_opt( 'sidebar_post_pos' );
}
?>
