...
$readmore_text = lawsight_get_opt( 'readmore_text' );
?>
        ...
        <?php else :
            if (has_post_thumbnail()) {
                echo '<div class="entry-featured"><div class="post-image">'; ?>
                    <a href="<?php echo esc_url( get_permalink()); ?>"><?php the_post_thumbnail('lawsight-large'); ?></a>
                <?php echo '</div></div>';
            } ?>
        <?php endif; ?>
        <div class="entry-body">
            <div class="entry-holder">
                <?php lawsight_archive_meta(); ?>
