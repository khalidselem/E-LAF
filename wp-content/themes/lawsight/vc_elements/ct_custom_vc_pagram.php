...
vc_add_param("vc_row", array(
    "type" => "dropdown",
    "class" => "",
    "heading" => esc_html__("Custom Style", 'lawsight'),
    ...
    "group" => esc_html__("Customs", 'lawsight'),
));

vc_add_param("vc_row", array(
    "type" => "dropdown",
    "class" => "",
    "heading" => esc_html__("Background Image Position", 'lawsight'),
    ...
    "group" => esc_html__("Design Options", 'lawsight'),
));

vc_add_param("vc_row_inner", array(
    "type" => "dropdown",
    "class" => "",
    "heading" => esc_html__("Content Border Box", 'lawsight'),
...
vc_add_param("vc_column", array(
    "type" => "dropdown",
    "class" => "",
    "heading" => esc_html__("Column Offset", 'lawsight'),
...
vc_add_param("vc_column_inner",
    array(
        ...
        'heading' => esc_html__( 'Animation', 'lawsight' ),
...
vc_add_param("vc_single_image",
    array(
        ...
        "group" => esc_html__("Styles", 'lawsight'),
    )
);
vc_add_param("vc_single_image",
    array(
        'type' => 'dropdown',
        'heading' => esc_html__( 'Image alignment small (768px < Screen < 991px)', 'lawsight' ),
...
vc_add_param("vc_single_image",
    array(
        'type' => 'dropdown',
        'heading' => esc_html__( 'Image alignment small (Screen < 767px)', 'lawsight' ),
...
vc_add_param("vc_column_text",
    array(
        'type' => 'dropdown',
        'heading' => esc_html__( 'Text Align', 'lawsight' ),
