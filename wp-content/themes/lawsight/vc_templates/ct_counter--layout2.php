...
wp_enqueue_script( 'lawsight-counter-lib' );
wp_enqueue_script( 'lawsight-counter' );
$icon_image_url = '';
if (!empty($icon_image)) {
    ...
    <div class="ct-counter-inner">
        <div class="ct-counter-holder">
            ...
            <?php } else { ?>
                <?php if($icon_class):?>
                    <div class="ct-counter-icon">
                        <i class="text-gradient <?php echo esc_attr($icon_class); ?> <?php if(!empty($icon_color)) { echo 'colored'; } ?>" style="<?php if(!empty($icon_color)) { echo 'color:'.esc_attr($icon_color).';'; } if(!empty($icon_font_size)) { echo 'font-size:'.esc_attr($icon_font_size).'px;'; } ?>"></i>
                    </div>
                <?php endif;?>
            <?php } ?>
            ...
            <?php if(!empty($description)) : ?>
                <div class="ct-counter-description">
