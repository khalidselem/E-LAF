...
?>
<div class="ct-fancybox-default col-same-height <?php echo esc_attr($el_class.' '.$animation_classes); ?>" style="<?php if(!empty($bg_color)) { echo 'background-color:'.esc_attr($bg_color).';'; } ?>">
