...
?>
<div id="<?php echo esc_attr($atts['html_id']);?>" class="ct-heading <?php echo esc_attr( $el_class ); ?> <?php echo esc_attr( $styles.' '.$align_lg.' '.$align_md.' '.$align_sm.' '.$align_xs.' '.$animation_classes ); ?>">
    ...
    <?php endif; ?>
    <?php if($styles == 'style2' && $show_gap == 'show') : ?>
        <div class="h-gap-sub"><span <?php if(!empty($gap_color)) : ?>style="background-color:<?php echo esc_attr($gap_color); ?>" <?php endif; ?>></span></div>
    <?php endif; ?>
    ...
    <?php if($styles == 'style1' && $show_gap == 'show') : ?>
        <div class="h-gap">
            <span>
    ...
    <?php if(!empty($description)) : ?>
        <div class="ct-heading-desc fw-<?php echo esc_attr($description_font_weight); ?>" <?php if(!empty($description_color)) : ?>style="color:<?php echo esc_attr($description_color); ?>"<?php endif; ?>><?php echo wp_kses_post( $description ); ?></div>
    <?php endif; ?>
</div>