...
class CThemes_Widget_Extends
{
    ...
    function __construct()
    {
        ...
        if ( is_admin() )
        {
            add_action( 'in_widget_form', array( $this, 'lawsight_extend_widget_form' ), 10, 3 );
            add_filter( 'widget_update_callback', array( $this, 'lawsight_extend_widget_update' ), 10, 4 );
        }
        add_filter( 'dynamic_sidebar_params', array( $this, 'lawsight_extend_widget_params'), 10, 2 );
    }
     ...
     */
    function lawsight_extend_widget_form( $widget, $return, $instance )
    {
        ...
        <p>
            <label for="widget-<?php echo esc_attr( $widget->id_base . '-' . $widget->number ); ?>-el_class"><?php esc_html_e( 'CSS Class', 'lawsight' ); ?></label>
     ...
     * @return  array                   An array of the new widget's settings.
     */
    function lawsight_extend_widget_update( $instance, $new_instance, $old_instance, $object )
    {
     ...
     */
    function lawsight_extend_widget_params( $params )
    {
