...
class Recent_Posts_Widget extends WP_Widget
{
    function __construct()
    {
        parent::__construct(
            'ct_recent_posts',
            esc_html__( '* Recent Posts', 'lawsight' ),
            array(
                'description' => esc_html__( 'Shows your most recent posts.', 'lawsight' ),
    ...
    function widget( $args, $instance )
    {
        ...
        $title = empty( $instance['title'] ) ? esc_html__( 'Recent Posts', 'lawsight' ) : $instance['title'];
    ...
    function form( $instance )
    {
        ...
        $title         = $instance['title'] ? esc_attr( $instance['title'] ) : esc_html__( 'Recent Posts', 'lawsight' );
        $number        = absint( $instance['number'] );
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('post_in')); ?>"><?php esc_html_e( 'Post in', 'lawsight' ); ?></label>
         ...
         <p><label for="<?php echo esc_url($this->get_field_id('show_featured_image')); ?>"><?php esc_html_e( 'Featured Image', 'lawsight' ); ?></label>
         <select class="widefat" id="<?php echo esc_attr( $this->get_field_id('show_featured_image') ); ?>" name="<?php echo esc_attr( $this->get_field_name('show_featured_image') ); ?>">
            <option value="show"<?php if( $show_featured_image == 'show' ){ echo 'selected="selected"';} ?>><?php esc_html_e('Show', 'lawsight'); ?></option>
            <option value="hide"<?php if( $show_featured_image == 'hide' ){ echo 'selected="selected"';} ?>><?php esc_html_e('Hide', 'lawsight'); ?></option>
         </select>
         </p>
